...
type Chain struct {
	...
	Node string `long:"node" description:"The blockchain interface to use." choice:"btcd" choice:"bitcoind" choice:"neutrino" choice:"ltcd" choice:"litecoind" choice:"lightwallet" choice:"xsnd" `
	...
	MinHTLCIn           lnwire.MilliSatoshi `long:"minhtlгc" description:"The smallest HTLC we are willing to accept on our channels, in millisatoshi"`
